 ...
 * @author Quang
 */
public class Frm_XuatHoaDonVienPhi extends javax.swing.JFrame {
private final Date today = new Date();
    ...
    public void comboBox(){
        ...
        cboMaHD.addItem("HDVP01");
        cboMaHD.addItem("HDVP02");
        cboMaHD.addItem("HDVP03");
        cboMaHD.addItem("HDVP04");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("XUẤT HOÁ ĐƠN VIỆN PHÍ ");
        ...
        jLabel4.setText("Số tiền viện phí:");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtTienVP)
                    .addComponent(cboMaHD, 0, 108, Short.MAX_VALUE))
                .addGap(101, 101, 101)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
    ...
    run.setText("+"+"              Mã hoá đơn viện phí: "+cboMaHD.getSelectedItem()+"                         "+"              +");
    ///////////////////////
     XWPFParagraph paragraph8 = document.createParagraph();
    run = paragraph8.createRun();
    run.setText("+"+"              Mã hồ sơ: "+cboMaHS.getSelectedItem()+"                                  "+"                      +");
    ///////////////////////
     XWPFParagraph paragraph9 = document.createParagraph();
    run = paragraph9.createRun();
    run.setText("+"+"              Số tiền viện phí: "+txtTienVP.getText()+"                            "+"                      +");
    // dòng 6
    ...
    FileOutputStream out = new FileOutputStream(new File("phieuHoaDonVienPhi.docx"));
    document.write(out);
    out.close();
    document.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_XuatHoaDonVienPhi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_XuatHoaDonVienPhi().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox cboMaHD;
